...
@Component
class VendorInterceptor : HandlerInterceptor {
    @Autowired
    ...
    override fun preHandle(req: HttpServletRequest, resp: HttpServletResponse, handler: Any): Boolean {
        ...
        if (loginedMember.roleLevel == 4 && loginedMember.extra__authenticationLevel == 1) {
        ...
        rq.printReplaceJs("회원님은 물품 공급업자가 아닙니다.", "/usr/home/main")
