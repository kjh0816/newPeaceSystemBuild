...
class DirectorService(
    ...
    fun putInForDirector(
        ...
        directorRepository.putInForDirector(
            loginedMemberId,
            aboutMe,
            originFileName,
            typeCode,
    ...
    fun save(multipartFile: MultipartFile, loginedMemberId: Int, aboutMe: String) {

        fun save(multipartFile: MultipartFile, loginedMemberId: Int, aboutMe: String): ResultData {
            ...
            // 해당 파일의 실제 확장자 명
            var fileExt: String =
                Ut.getFileExtFromFileName(multipartFile.originalFilename!!).lowercase(Locale.getDefault())
            ...
            val metaDataRd: ResultData = putInForDirector(
                relId,
                aboutMe,
                originFileName,
                typeCode,
            ...
            return ResultData.from("S-1", "파일이 생성되었습니다.", "directorId", directorId, "targetDirPath", targetDirPath)
        }
